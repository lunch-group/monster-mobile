...
//Name: survivor_ranger.ma
//Last modified: Sat, Jan 17, 2015 03:32:22 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.1534819799679514 7.9565449116442686 18.352147506647157 ;
	setAttr ".r" -type "double3" -14.738352727858368 692.99999999993679 8.9240499230982709e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 21.309667942712789;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "survivor_ranger_mesh";
...
createNode mesh -n "survivor_ranger_meshShape" -p "survivor_ranger_mesh";
	setAttr -k off ".v";
	...
	setAttr ".dr" 1;
createNode mesh -n "survivor_ranger_meshShape1Orig" -p "survivor_ranger_mesh";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "groupId15.id" "survivor_ranger_meshShape.iog.og[0].gid";
connectAttr "lambert6SG.mwc" "survivor_ranger_meshShape.iog.og[0].gco";
connectAttr "groupId16.id" "survivor_ranger_meshShape.iog.og[1].gid";
connectAttr "lambert5SG.mwc" "survivor_ranger_meshShape.iog.og[1].gco";
...
connectAttr "survivor_ranger_meshShape.iog.og[1]" "lambert5SG.dsm" -na;
connectAttr "lambert5SG.msg" "materialInfo4.sg";
connectAttr "lambert5.msg" "materialInfo4.m";
connectAttr "lambert6.oc" "lambert6SG.ss";
connectAttr "survivor_ranger_meshShape.iog.og[0]" "lambert6SG.dsm" -na;
